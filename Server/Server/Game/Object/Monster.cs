...
namespace Server.Game
{
    ...
    {
        private readonly int _chaseCellDist = 20;

        private long _coolTick;
        private long _nextMoveTick;

        private long _nextSearchTick;
        private readonly int _searchCellDist = 10;

        private readonly int _skillRange = 1;
        ...
        protected virtual void UpdateMoving()
        {
            ...
            var path = Room.Map.FindPath(CellPos, _target.CellPos, false);
        ...
        protected virtual void UpdateSkill()
        {
            if (_coolTick == 0)
            {
                ...
                // 스킬 사용 Broadcast
                var skill = new S_Skill { Info = new SkillInfo() };
                skill.ObjectId = Id;
                skill.Info.SkillId = skillData.id;
                Room.Broadcast(skill);

                // 스킬 쿨타임 적용
                var coolTick = (int)(1000 * skillData.cooldown);
